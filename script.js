...
function canvas(){
    ...
    function files(index) {
        var data = `https://zelt.app/assets/img/sprites/svgsprites.svg
...
// Use this code to console the canvas images
    // var imageUrls = [];
...
swiper()
function gsappage(){
    gsap.to('#page h1, #page h3',{
       
    })
    gsap.from('#page h1, #page h3,#page canvas',{
...
var circletext = document.querySelector('#circle h1')
var btn = document.querySelectorAll('#btn')
var page = document.querySelector('.swiper')
var slide = document.querySelectorAll('.swiper-slide')
var swipe = document.querySelector('#page6')
...
swipe.addEventListener('click',function(){
    if(clickCounter < slideCount - 1){
        clickCounter++;
        slide.forEach(function (a) {
        a.style.transform = `translateX(${-30 * clickCounter}vw)`
        })
    }else{
        slide.forEach(function (a) {
            a.style.transform = `translateX(0vw)`
            clickCounter = 0;
        })
    }
})
